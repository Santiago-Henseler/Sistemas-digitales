...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_decoder is
  port (
    ...
    \G_PROBE_OUT[4].wr_probe_out_reg[4]\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_decoder is
  ...
  signal \^g_probe_out[4].wr_probe_out_reg[4]\ : STD_LOGIC;
  signal Hold_probe_in : STD_LOGIC;
  signal \^sr\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \data_info_probe_in__71\ : STD_LOGIC_VECTOR ( 2 downto 1 );
...
begin
  \G_PROBE_OUT[4].wr_probe_out_reg[4]\ <= \^g_probe_out[4].wr_probe_out_reg[4]\;
  SR(0) <= \^sr\(0);
  in0 <= \^in0\;
...
\G_PROBE_OUT[4].wr_probe_out[4]_i_1\: unisim.vcomponents.LUT2
    generic map(
      ...
      I0 => s_daddr_o(2),
      I1 => s_daddr_o(1),
      O => \^g_probe_out[4].wr_probe_out_reg[4]\
    );
...
\rd_en[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
        ...
        port map (
      I0 => \^g_probe_out[4].wr_probe_out_reg[4]\,
      I1 => \rd_en[5]_i_2_n_0\,
      I2 => s_daddr_o(0),
      I3 => Read_int_i_3,
      I4 => Read_int_i_4,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_in_one is
  ...
  signal p_55_out : STD_LOGIC_VECTOR ( 38 downto 30 );
  signal p_56_out : STD_LOGIC_VECTOR ( 38 downto 30 );
  signal probe_all_int : STD_LOGIC_VECTOR ( 116 downto 39 );
  ...
  signal up_activity0148_out : STD_LOGIC;
  signal up_activity0152_out : STD_LOGIC;
  signal up_activity0156_out : STD_LOGIC;
  signal up_activity0160_out : STD_LOGIC;
  signal up_activity0164_out : STD_LOGIC;
  signal up_activity0168_out : STD_LOGIC;
  signal up_activity0172_out : STD_LOGIC;
  signal up_activity0176_out : STD_LOGIC;
  signal up_activity0180_out : STD_LOGIC;
  signal up_activity0184_out : STD_LOGIC;
  signal up_activity0188_out : STD_LOGIC;
  signal up_activity0192_out : STD_LOGIC;
  signal up_activity0196_out : STD_LOGIC;
  signal up_activity0200_out : STD_LOGIC;
  signal up_activity0204_out : STD_LOGIC;
  signal up_activity0208_out : STD_LOGIC;
  signal up_activity0212_out : STD_LOGIC;
  signal up_activity0216_out : STD_LOGIC;
  signal up_activity0220_out : STD_LOGIC;
  signal up_activity0224_out : STD_LOGIC;
  signal up_activity0228_out : STD_LOGIC;
  signal up_activity0232_out : STD_LOGIC;
  signal up_activity0236_out : STD_LOGIC;
  signal up_activity0240_out : STD_LOGIC;
  signal up_activity0244_out : STD_LOGIC;
...
\Bus_Data_out[12]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00CCF0AA"
    )
        port map (
...
\Bus_Data_out[13]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00CCF0AA"
    )
        port map (
...
\Bus_Data_out[14]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00CCF0AA"
    )
        port map (
...
\Bus_Data_out[15]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00CCF0AA"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_width is
  ...
  signal \addr_count[0]_i_1_n_0\ : STD_LOGIC;
  signal \addr_count[1]_i_1_n_0\ : STD_LOGIC;
  signal probe_width_mem : STD_LOGIC_VECTOR ( 11 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \addr_count[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \addr_count[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \probe_width_int[10]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \probe_width_int[11]_i_1\ : label is "soft_lutpair16";
begin
...
\probe_width_int[8]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_out_all is
  ...
  attribute SOFT_HLUTNM of \G_PROBE_OUT[5].wr_probe_out[5]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \G_PROBE_OUT[6].wr_probe_out[6]_i_1\ : label is "soft_lutpair19";
begin
...
\G_PROBE_OUT[4].wr_probe_out_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => \out\,
      CE => '1',
      D => \G_PROBE_OUT[4].wr_probe_out[4]_i_1\,
      Q => wr_probe_out(4),
      R => \G_PROBE_OUT[0].wr_probe_out[0]_i_1_n_0\
    );
...
\Probe_out_reg_int[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \^xsdb_addr_2_0_p2_reg[2]\(2),
      I2 => \^xsdb_addr_2_0_p2_reg[2]\(0),
      I3 => \^xsdb_addr_2_0_p2_reg[2]\(1),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio is
  ...
  attribute C_NUM_PROBE_OUT of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio : entity is 7;
  attribute C_PIPE_IFACE : integer;
  ...
  attribute C_PROBE_IN0_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio : entity is 10;
  ...
  attribute C_PROBE_IN1_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio : entity is 10;
  ...
  attribute C_PROBE_IN2_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio : entity is 10;
  ...
  attribute LC_PROBE_IN_WIDTH_STRING of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio : entity is "2048'";
  ...
  attribute LC_TOTAL_PROBE_IN_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio : entity is 39;
  attribute LC_TOTAL_PROBE_OUT_WIDTH : integer;
  attribute LC_TOTAL_PROBE_OUT_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio : entity is 7;
  attribute dont_touch : string;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio is
  ...
  signal probe_width_int : STD_LOGIC_VECTOR ( 11 downto 8 );
...
DECODER_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_decoder
     port map (
      ...
      internal_cnt_rst => internal_cnt_rst,
      \out\ => bus_clk,
      \probe_width_int_reg[11]\(2 downto 1) => probe_width_int(11 downto 10),
      \probe_width_int_reg[11]\(0) => probe_width_int(8),
...
PROBE_IN_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_in_one
     port map (
      D(38) => probe_in4(0),
      D(37 downto 30) => probe_in3(7 downto 0),
      D(29 downto 20) => probe_in2(9 downto 0),
      D(19 downto 10) => probe_in1(9 downto 0),
      D(9 downto 0) => probe_in0(9 downto 0),
      E(0) => DECODER_INST_n_7,
...
PROBE_IN_WIDTH_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_width
     port map (
      Q(2 downto 1) => probe_width_int(11 downto 10),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute C_PROBE_IN2_WIDTH : integer;
  attribute C_PROBE_IN2_WIDTH of inst : label is 10;
  attribute C_PROBE_IN30_WIDTH : integer;
  ...
  attribute LC_PROBE_IN_WIDTH_STRING : string;
  attribute LC_PROBE_IN_WIDTH_STRING of inst : label is "2048'";
  attribute LC_PROBE_OUT_HIGH_BIT_POS_STRING : string;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio
     port map (
      ...
      probe_in198(0) => '0',
      probe_in199(0) => '0',
      probe_in2(9 downto 0) => probe_in2(9 downto 0),
      probe_in20(0) => '0',
      probe_in200(0) => '0',
      probe_in201(0) => '0',
      probe_in202(0) => '0',
